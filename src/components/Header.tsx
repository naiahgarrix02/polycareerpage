const Header = () => {
  return (
    <div className='flex flex-row w-full py-6 lg:px-40 md:px-12 px-6 gap-[280px] items-center'>
        <img src='/logo.svg' alt='Logo' />
        <div className='gap-[64px] w-2/3 flex flex-row items-center ld:block hidden'>
